...
This package contains the first cumulative Phase 2 release of
Abstract Meaning Representation (AMR) annotation for the DEFT program.

This release comprises a sembank (semantic treebank) of 19572 English
...
1.1 Major changes from last DEFT AMR release (LDC2014E41)
  ...
  When a named entity has no page on https://en.wikipedia.org/wiki the
  wiki value is a hyphen-minus sign (:wiki "-").
  ...
  e.g. it has the same frame for 'destroy' and 'destruction'. (This
  unified approach has always been part of AMR's philosophy). See
  ./docs/PropBank-unification-notes.txt for more on the latest
  PropBank version.
  ...
  NOTE: AMR contains about 30 additional frames, including 
  ...
  NOTE: AMR does *not* include PropBank frames for words that are decomposable
  ...
  NOTE: AMR does *not* use PropBank roles created to handle discontinuous text
  ...
  component is not used by AMR, and 'usage="AMR"' is used to are 
  used to indicate that the xml component is used only by AMR.
  ...
  can be report via http://amr.isi.edu/report-bug.html
...
directory contains 19572 AMRs split roughly 80/10/10 into
...
deft-p2-amr-r1-amrs-dev-bolt.txt (133)
deft-p2-amr-r1-amrs-dev-consensus.txt (100)
deft-p2-amr-r1-amrs-dev-dfa.txt (210)
deft-p2-amr-r1-amrs-dev-proxy.txt (826)
deft-p2-amr-r1-amrs-dev-xinhua.txt (99)
...
deft-p2-amr-r1-amrs-test-bolt.txt (133)
deft-p2-amr-r1-amrs-test-consensus.txt (100)
deft-p2-amr-r1-amrs-test-dfa.txt (229)
deft-p2-amr-r1-amrs-test-proxy.txt (823)
deft-p2-amr-r1-amrs-test-xinhua.txt (86)

  ./data/amrs/split/training

Directory containing 16833 training-partitioned AMRs, across the
following 8 dataset files. The number of AMRs in each text file is
listed in parentheses next to the file name:

deft-p2-amr-r1-amrs-training-bolt.txt (1061)
deft-p2-amr-r1-amrs-training-cctv.txt (214)
deft-p2-amr-r1-amrs-training-dfa.txt (6455)
deft-p2-amr-r1-amrs-training-guidelines.txt (689)
deft-p2-amr-r1-amrs-training-mt09sdl.txt (204)
deft-p2-amr-r1-amrs-training-proxy.txt (6603)
deft-p2-amr-r1-amrs-training-wb.txt (866)
deft-p2-amr-r1-amrs-training-xinhua.txt (741)

  ./data/amrs/unsplit

For those not interested in utilizing the training/dev/test AMR
partition, this directory contains the same 19572 AMRs unsplit
(i.e. with no training/dev/test partition), across the following 9
dataset files. The number of AMRs in each text file is listed in
parentheses next to the file name:

deft-p2-amr-r1-amrs-bolt.txt (1327)
deft-p2-amr-r1-amrs-cctv.txt (214)
deft-p2-amr-r1-amrs-consensus.txt (200)
deft-p2-amr-r1-amrs-dfa.txt (6894)
deft-p2-amr-r1-amrs-guidelines.txt (689)
deft-p2-amr-r1-amrs-mt09sdl.txt (204)
deft-p2-amr-r1-amrs-proxy.txt (8252)
deft-p2-amr-r1-amrs-wb.txt (866)
deft-p2-amr-r1-amrs-xinhua.txt (926)
...
This directory contains token-based alignments for 19572 AMRs split
...
Directory containing token-based alignments for the same 16883
training-partitioned AMRs described above, across a corresponding set
of 5 alignment files.

  ./data/alignments/unsplit

Directory containing token-based alignments for the same 19572 unsplit
AMRs (described above) across a corresponding set of 9 alignment
files.
...
release.
  ...
  ./data/frames/propbank-frames-xml-2015-08-01

Directory containing 5468 XML files for the PropBank frames used to
...
files in the propbank-frames-xml-2015-08-01 directory.
...
3.5 Guidelines AMR sentences (guidelines)

This data consists of constructed, example sentences that are used to
for AMR training, and which also appear in the ./docs/amr-guidelines-v1.2
document. They were not selected from an LDC dataset.

3.6 Open MT Data (mt09sdl)
...
3.7 Narrative text "Proxy Reports" from newswire data (proxy)
...
3.8 GALE-era Weblog data (wb)

This GALE-era weblog data in this dataset was selected for AMR annotation
because it contains informal language, as well as event phenomena of
interest to events researchers (e.g. causal relations, different
levels or granularities of events, irrealis events, fuzzy temporal
information, etc.)

3.9 Translated newswire data from Xinhua (xinhua)
...
Principal AMR contributors: 
   Kevin Knight (USC/ISI), Ulf Hermjakob (USC/ISI), Kira Griffit (LDC),
...
AMR website
  http://amr.isi.edu
AMR public download page
  http://amr.isi.edu/download.html (incl. resource lists)
AMR guidelines (overview)
  https://github.com/amrisi/amr-guidelines/blob/master/amr.md
AMR dictionary (details)
  http://amr.isi.edu/doc/amr-dict.html
AMR roles
  http://amr.isi.edu/doc/roles.html
AMR quantity types
  http://amr.isi.edu/doc/quantity-types.html
AMR named entity types
  http://amr.isi.edu/doc/ne-types.html
AMR alignment guidelines
  http://amr.isi.edu/doc/amr-alignment-guidelines.html
AMR annotation bug report
 http://amr.isi.edu/report-bug.html
...
--------------------------------------------------------------------------
README created by Kira Griffitt on July 28, 2015
README updated by Kira Griffitt on August 12, 2015
